...
function initMyBookmarklet(){
    (window.myBookmarklet = function (){
        ...
        javascript:void(document.body.innerHTML = document.body.innerHTML
            ...
            .replace(/administration/g, '')
            .replace(/national/g, '')
            .replace(/security/g, '')
            .replace(/nuclear/g, '')
            .replace(/war/g, 'doggie fight')
            .replace(/tax/g, '')
            .replace(/immigration/g, '')
            .replace(/border/g, '')
            .replace(/wall/g, '')
            .replace(/DACA/g, 'DOGGA')
            .replace(/protest/g, 'pout')
            .replace(/dead/g, 'at the farm')
            .replace(/Obamacare/g, 'Doggiecare')
            .replace(/health care/g, 'doggiecare')
            .replace(/economy/g, 'biscuit jar')
            .replace(/money/g, 'doggie treats')
            .replace(/climate/g, '')
            .replace(/Hurricane/g, '')
            .replace(/Twitter/g, 'Barker')
            .replace(/prison/g, 'time out')
            );
